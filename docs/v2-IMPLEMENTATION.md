...
4. 每周有交付：每周末必须有可演示的进度
5. 风险早发现：第 2 周结束必须完成 schema 评审，第 4 周结束必须完成核心 UI
```
...
| W3 | 无限恐怖故事大纲 | 无 |
| W4 | 无限恐怖 Demo JSON | inventory 完成 |
...
- 技术评估（Capacitor vs Tauri vs PWA）
- 原型开发（如果选 Capacitor）
...
| 阶段 | 开发工作量 | 内容工作量 | 总周期 |
|------|------------|------------|--------|
| Q3 MVP | 19 天 | 14 天 | 12 周（含测试+迭代） |
| Q4 核心互动 | 17 天 | 12 天 | 12 周 |
| Q1 类型扩展 | 10 天 | 15 天 | 12 周 |
...
| 12 月底 | 是否启动移动端？ | 是 / 否 | 取决于 Q3/Q4 用户数据 |
